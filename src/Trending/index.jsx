    ...
    <>
      <div className="trendingVIdeos">
        <div className="tendingIcon" style={mode?dark:light}>
          <div className="iconback" style={mode?{backgroundColor:"rgb(15,15,15)"}:{backgroundColor:"rgb(224, 233, 240)"}}> 
        ...
        {!loading ? (
          allData.length > 0 && (
            <div className="ghnj" style={mode?{backgroundColor:"rgb(0,0,0)"}:null}>
              {allData.map((item) => (
